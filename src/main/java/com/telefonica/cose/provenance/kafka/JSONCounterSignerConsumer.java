...
public class JSONCounterSignerConsumer {

    private static final Logger log = LoggerFactory.getLogger(JSONCounterSignerConsumer.class.getSimpleName());
    ...
    public static void main(String[] args) {
        ...
        String topic = "json_signed_messages";
            ...
            while (true) {
                ...
                for (ConsumerRecord<String, String> record : records) {
                    ...
                    try {
                        ...
                        String signedMessageWithCS= signer.addCounterSignature(record.value(),"ietf-provenance-augmented", "ietf-provenance-augmented:interfaces-provenance", "ec3.key");

                        // Enviar mensaje firmado al nuevo topic
                        String outputTopic = "json_signedCS1_messages";
                        ProducerRecord<String, String> signedRecord = new ProducerRecord<>(outputTopic, record.key(), signedMessageWithCS);
